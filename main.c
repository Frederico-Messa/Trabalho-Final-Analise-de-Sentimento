...
//int main (char* nome_dicionario, char* nome_texto, char* nome_saida) {
int main () {
    FILE *dicionario;
    FILE *texto;
    FILE *arq_saida_abp;
    ...
    char* nome_dicionario = "lexicon_2k_shuffled.txt";
    char* nome_texto = "movieReviews1000.txt";
    char* nome_saida = "saida.txt";

    dicionario = fopen(nome_dicionario,"r");
     ...
     texto = fopen(nome_texto, "r");
     arq_saida_abp = fopen(nome_saida, "w");
     while(1){
     ...
     texto = fopen(nome_texto, "r");
     arq_saida_avl = fopen(nome_saida, "w");
     while(1){
